...
const Content = () => {
  return (
    <div className="relative flex flex-1 font-modefor">
      <img className='h-[80vh] w-full bg-no-repeat bg-cover border brightness-75' src={BlogBg} alt="" />
      <div className='absolute inset-0 flex justify-center items-center'>
        <div className='relative flex flex-col gap-4 justify-around items-center h-[55%] w-[40%] bg-[#F7F5F3] opacity-90'>
          <div className='absolute top-0 left-0 transform -translate-x-1/2 -translate-y-1/2 bg-blue-600 text-white text-xs font-bold py-2 px-3 rounded-full'>
            Welcome
          </div>
