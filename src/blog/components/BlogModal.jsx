...
const BlogModal = ({ blog, onClose }) => {
  ...
  return createPortal(
    ...
    >
      <div
        className="bg-white p-8 rounded-md shadow-lg h-[90vh] overflow-y-auto w-[90vw] md:w-[90vw] lg:w-[90vw] relative"
      ...
      >
        ...
        <div className="sticky top-0 text-center md:text-[20px] lg:text-[30px] font-bold mb-4 z-[9999]">{blog.title}</div>
