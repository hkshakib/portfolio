...
const Categories = () => {
  ...
  return (
    <div
      className={`hidden lg:flex justify-around items-center p-5 font-modefor shadow-lg ${
        isNavbarSticky
          ? " bg-white border-b fixed top-0 left-0 right-0 z-50 "
          : ""
      }`}
    >
      <div className="hidden lg:flex gap-8 justify-between items-center text-[14px] tracking-widest">
        <a href="/programming">
