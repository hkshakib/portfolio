  ...
  return (
    <div className='flex flex-col lg:flex-row'>
        ...
        <div className='flex lg:flex-1 m-[15px] lg:ml-[40px]'>
            <img className='bg-contain rounded-lg' src={AchivmentImage} alt="skills" />
        </div>
        ...
        <div className='flex flex-col lg:flex-1 lg:justify-start lg:items-start lg:pt-[50px] pl-4 lg:pl-12'>
            ...
            <Achivement Text={"8th Among Private University in ICPC Preliminary 2021."}/>
            <Achivement Text={"Top 10 in NSU ICE Fest Inter University Programming Contest 2020."}/>
            <Achivement Text={"Champions, Mathophobic Skyvers, LU Intra University Programming Competition 2020."}/>
            <Achivement Text={"Champions, LUZeroIQ, LU Intra University Programming Competition 2021."}/>
            <Achivement Text={"Top 6 in Bangladesh, LUZeroIQ, IEEE Extreme 14."}/>
            <Achivement Text={"Top 10 In Country Wise Ranking, Codeforces Round 643 (Div. 2)."}/>
