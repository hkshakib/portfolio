    ...
    <div className='flex flex-col '>
      ...
      <div className='flex'>
        <div className='flex ml-[70px]'>
          <img className='h-[200px] w-[200px]' src={SchoolLogo} alt="UniversityLogo" />
        </div>
        <div className='flex flex-col justify-center mb-[60px] ml-[70px]'>
          <h1 className='font-bold text-[30px] font-mono'>Scholarshome</h1>
          <h2 className='text-[25px]'>Higher Secondary</h2>
          <h2 className='text-[23px]'>July 2014 - July 2016</h2>
          <h2 className='text-[23px]'>Sylhet, Bangladesh</h2>
        </div>
      </div>
    </div>
