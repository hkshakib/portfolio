...
const Education = () => {
  return (
    <div className='flex flex-col '>
      <h1 className='text-[35px] lg:text-[56px] lg:ml-[90px] font-mono border-b-[1px] lg:p-0 pl-3'>Education</h1>

      <div className='flex'>
        <div className='flex'>
          <img src={UniversityLogo} alt="UniversityLogo" className='md:h-[150px] lg:h-auto'/>
        </div>
