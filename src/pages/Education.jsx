  ...
  return (
    <section id="education" className="flex pt-[50px] lg:pt-[200px] relative">
      <div className="flex flex-col ">
        <h1 className="text-[35px] lg:text-[56px] lg:ml-[90px] font-mono border-b-[1px] lg:p-0 pl-3">
          Education
        </h1>
        ...
        <div className="flex">
          <div className="flex">
            <img
              src={UniversityLogo}
              alt="UniversityLogo"
              className="md:h-[150px] lg:h-auto"
            />
          </div>
          <div className="flex flex-col justify-center mb-[60px] border-b-[1px]">
            <h1 className="font-bold text-[20px] lg:text-[30px] font-mono">
              Leading University
            </h1>
